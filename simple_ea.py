...
target  = list("HELLO WORLD! THIS PROGRAM IS WRITTEN IN PYTHON! THE SPEED OF THIS EVOLUTIONARY ALGORITHM IS REALLY IMPRESSIVE!")
alphabet = " !ABCDEFGHIJLKLMNOPQRSTUVWXYZ"
INDIVIDUAL_SIZE = len(target)

def create_ind():
    return [ choice(alphabet) for _ in xrange(INDIVIDUAL_SIZE) ]
